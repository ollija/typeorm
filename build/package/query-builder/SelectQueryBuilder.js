...
var SelectQueryBuilder = /** @class */ (function (_super) {
    ...
    SelectQueryBuilder.prototype.createSelectExpression = function () {
        ...
        this.expressionMap.selects
            ...
            var selectionObj = { selection: _this.replacePropertyNames(select.selection), aliasName: select.aliasName };
            if (_this.connection.driver instanceof PostgresDriver_1.PostgresDriver && select.selection.substring(0, 8).toUpperCase() === "DISTINCT") {
